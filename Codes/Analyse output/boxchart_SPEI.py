...
OUT_PNG = "/home/mohammad/Desktop/1/2/SPI_SPEI_monthly_2000_2025.png"
OUT_PDF = "/home/mohammad/Desktop/1/2/SPI_SPEI_monthly_2000_2025.pdf"
...
def plot_spi_spei(dates, spi, spei, out_png, out_pdf, y_lim=3, dpi_fig=1500):
    ...
    # ---- Legend (blue = wet, red = dry) ----
    legend_elements = [
        Patch(facecolor="blue", edgecolor="blue", label="Wet (index > 0)"),
        Patch(facecolor="red",  edgecolor="red",  label="Dry (index < 0)")
    ]
    axes[0].legend(handles=legend_elements, loc="upper right", frameon=False, ncol=2)
